...
<head>
    ...
    <title>Login - Digital Store Services</title>
    ...
    <style>
        ...
        /* Divider line between traditional and social auth */
        .auth-divider {
            display: flex;
            align-items: center;
            text-align: center;
            ...
            <div class="col-md-8 col-lg-6 col-xl-5">
                ...
                <div class="card-body p-4 p-sm-5">
                    ...
                    <div class="text-center mb-4">
                        <i class="bi bi-shield-lock-fill mb-2" style="font-size: 2.5rem; color: var(--color-secondary);"></i>
                        <h2 class="brand-title mb-1">Welcome Back</h2>
                        <p class="text-muted small">Sign in to manage your licenses & purchases</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="mb-3">
                            <div class="d-flex justify-content-between align-items-center mb-1">
                                ...
                                <a href="#" class="auth-link small text-muted">Forgot Password?</a>
                            </div>
                            <div class="input-group-custom">
                                ...
                                <button type="button" class="input-icon-right" id="password-toggle" title="Show password">
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            <div class="form-check">
                                ...
                                <label class="form-check-label small text-secondary" style="cursor: pointer;" for="remember">
                                    Remember me
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="text-center mt-4">
                            ...
                            <a href="{{ route('register') }}" class="auth-link small ms-1">Create account</a>
                        </div>
