                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbar-collapse-content">
                        ...
                        <ul class="navbar-nav mx-auto mb-2 mb-lg-0 gap-1" id="nav-menu-links">
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{ Route::currentRouteName() == 'home' ? 'active' : '' }}" href="{{ route('home') }}" id="link-home">
                                    Home
                                </a>
                            </li>
                            ...
                            <li class="nav-item dropdown" id="nav-item-products">
                                ...
                                <a class="nav-link {{ Route::currentRouteName() == 'products' ? 'active' : '' }}" href="{{ route('products') }}" id="link-products" role="button" tabindex="0">
                                    Products  
                                </a>

                                <div class="dropdown-menu-custom" aria-label="Products Submenu">
                                    <a href="{{ route('categories', 'office-suite') }}" id="sublink-analytics">
                                        <i class="bi bi-bar-chart-steps"></i> Office Solutions
                                    </a>
                                    <a href="{{ route('categories', 'ai-tools') }}" id="sublink-ai">
                                        <i class="bi bi-robot"></i> Neural Engines
                                    </a>
                                    <a href="{{ route('categories', 'vpn-security') }}" id="sublink-security">
                                        <i class="bi bi-shield-check"></i> Cyber Shield
                                    </a>
                                    <a href="{{ route('products') }}" id="sublink-all">
                            ...
                            <!-- Categories -->
                            <li class="nav-item">
                                <a class="nav-link {{ Route::currentRouteName() == 'categories' ? 'active' : '' }}" href="{{ route('categories') }}" id="link-categories">
                                    Categories
                                </a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link {{ Route::currentRouteName() == 'about' ? 'active' : '' }}" href="{{ route('about') }}" id="link-about">About</a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link {{ Route::currentRouteName() == 'contact' ? 'active' : '' }}" href="{{ route('contact') }}" id="link-contact">Contact</a>
                            </li>
                        </ul>
                        ...
                        <div class="d-flex align-items-center gap-3 flex-column flex-lg-row mt-3 mt-lg-0" id="nav-right-actions">
                            ...
                            <div class="search-wrapper" id="nav-search-wrapper">
                                <form action="{{ route('products') }}" method="GET" class="search-form" id="nav-search-form"
                                    ...
                                    <!-- Input -->
                                    <input
                                        type="search" name="q" id="nav-search-input" class="search-input" placeholder="Search products…" value="{{ request('q') }}"aria-label="Search products">
                            ...
                            <!-- Auth Actions -->
                            <a class="btn btn-login" href="{{ route('login') }}" id="link-login">Login</a>
                            <a class="btn btn-register" href="{{ route('register') }}" id="link-register">Register</a>
